...
public class xyzMnuFormGroup$Help2 extends egl.ui.text.TextForm
{
	...
	public xyzMnuFormGroup$Help2( final com.ibm.javart.resources.Program ezeProgram, String ezeName ) throws com.ibm.javart.JavartException
	{
		...
		$1_1$ConstantFormField.setCurrentValue(0,"MNUHELP2",true);
		...
		$2_1$ConstantFormField.setCurrentValue(0,"This is Help Screen 2",true);
		...
		$24_1$ConstantFormField.setCurrentValue(0,"                PF2=Return to Menu",true);
