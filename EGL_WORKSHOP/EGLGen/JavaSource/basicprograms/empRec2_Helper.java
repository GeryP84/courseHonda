...
public class empRec2_Helper extends com.ibm.javart.util.JavartRecordHelper
{
	private static final long serialVersionUID = 70L;
	
	protected com.ibm.javart.resources.Program ezeProgram;
	public empRec2_Helper( com.ibm.javart.resources.Program ezeProgram )
	{
	...
	{
		return toJSON((basicprograms.empRec2) container);
	}
	...
	{
		fromJSON(node, (basicprograms.empRec2) container);
	}
	
	public com.ibm.javart.json.ValueNode toJSON(basicprograms.empRec2 structure ) throws com.ibm.javart.JavartException
	{
	...
	public com.ibm.javart.json.ValueNode toJSON(basicprograms.empRec2._1 structure ) throws com.ibm.javart.JavartException
	{
		com.ibm.javart.json.ObjectNode obj = new com.ibm.javart.json.ObjectNode();
	...
	public com.ibm.javart.json.ValueNode toJSON(basicprograms.empRec2._2 structure ) throws com.ibm.javart.JavartException
	{
		com.ibm.javart.json.ObjectNode obj = new com.ibm.javart.json.ObjectNode();
	...
	public com.ibm.javart.json.ValueNode toJSON(basicprograms.empRec2._3 structure ) throws com.ibm.javart.JavartException
	{
		com.ibm.javart.json.ObjectNode obj = new com.ibm.javart.json.ObjectNode();
	...
	public basicprograms.empRec2 fromJSON(com.ibm.javart.json.ValueNode node, basicprograms.empRec2 structure ) throws com.ibm.javart.JavartException
	{
	...
	public basicprograms.empRec2._1 fromJSON(com.ibm.javart.json.ValueNode node, basicprograms.empRec2._1 structure ) throws com.ibm.javart.JavartException
	{
		if (!(node instanceof com.ibm.javart.json.ObjectNode))
		{
			String ezeErrMessage = com.ibm.javart.util.JavartUtil.errorMessage( ezeProgram, com.ibm.javart.messages.Message.SOA_E_WS_PROXY_PARMETERS_JSON2EGL, null );
	...
	public basicprograms.empRec2._2 fromJSON(com.ibm.javart.json.ValueNode node, basicprograms.empRec2._2 structure ) throws com.ibm.javart.JavartException
	{
		if (!(node instanceof com.ibm.javart.json.ObjectNode))
		{
			String ezeErrMessage = com.ibm.javart.util.JavartUtil.errorMessage( ezeProgram, com.ibm.javart.messages.Message.SOA_E_WS_PROXY_PARMETERS_JSON2EGL, null );
	...
	public basicprograms.empRec2._3 fromJSON(com.ibm.javart.json.ValueNode node, basicprograms.empRec2._3 structure ) throws com.ibm.javart.JavartException
	{
		if (!(node instanceof com.ibm.javart.json.ObjectNode))
		{
			String ezeErrMessage = com.ibm.javart.util.JavartUtil.errorMessage( ezeProgram, com.ibm.javart.messages.Message.SOA_E_WS_PROXY_PARMETERS_JSON2EGL, null );
