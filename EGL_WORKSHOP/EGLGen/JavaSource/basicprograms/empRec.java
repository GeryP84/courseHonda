...
public class empRec extends com.ibm.javart.OverlayContainer
{
	...
	public empRec( java.lang.String ezeName, com.ibm.javart.Container ezeContainer, final com.ibm.javart.resources.Program ezeProgram, int ezeNullStatus, java.lang.String ezeSignature )
	...
	public empRec() throws com.ibm.javart.JavartException
	{
		this( "empRec", null, com.ibm.javart.util.ServiceUtilities.programInstance("empRec", false), com.ibm.javart.Value.SQL_NOT_NULLABLE, "TbasicPrograms/empRec;" );
	}
	
	public empRec( java.lang.String ezeName, com.ibm.javart.Container ezeContainer, com.ibm.javart.resources.Program ezeProgram, int ezeNullStatus, boolean ezeRedefinedFlag, java.lang.String ezeSignature )
	throws com.ibm.javart.JavartException
	{
		super( ezeName, ezeContainer, ezeNullStatus, 151, 151 );
		signature( ezeSignature );
	...
	{
		empRec ezeClone = (empRec)super.clone();
	...
	public class _1 implements java.io.Serializable
	{
		...
		{
			ezeProgram._setModified( empRec.this, "emp.lastName", emp__lastName, ezeValue );
			if ( ezeValue == null )
			{
		...
		{
			ezeProgram._setModified( empRec.this, "emp.firstName", emp__firstName, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "emp.empId", emp__empId, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "emp.empPhone", emp__empPhone, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "emp.partTimeInd", emp__partTimeInd, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
	...
	public class _2 implements java.io.Serializable
	{
		...
		{
			ezeProgram._setModified( empRec.this, "pay.grossPay", pay__grossPay, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.ytdGrossPay", pay__ytdGrossPay, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.fedTax", pay__fedTax, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.ytdFedTax", pay__ytdFedTax, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.netPay", pay__netPay, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.ytdNetPay", pay__ytdNetPay, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.stockPurchPerc", pay__stockPurchPerc, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "pay.four01KPerc", pay__four01KPerc, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
	...
	public class _3 implements java.io.Serializable
	{
		...
		{
			ezeProgram._setModified( empRec.this, "rpt.currDate", rpt__currDate, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "rpt.periodEndDate", rpt__periodEndDate, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "rpt.reportTimeStamp", rpt__reportTimeStamp, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
		...
		{
			ezeProgram._setModified( empRec.this, "rpt.payPeriod", rpt__payPeriod, ezeValue );
			if ( ezeValue == null )
			{
				throw new java.lang.NullPointerException();
			}
	...
	public com.ibm.javart.util.JavartRecordHelper helper()
	{
		if ( ezeHelper == null )
		{
			ezeHelper = new basicprograms.empRec_Helper( ezeProgram );
		}
		return ezeHelper;
	}
